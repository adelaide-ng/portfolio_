        ...
        <section className="text-white grid" id="aboutMe">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:px-32 py-16 xl-gap-16 items-center">
                ...
                <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                    ...
                    <p className="text-base text-justify lg:text-lg mt-4">I am currently a second-year student pursuing a degree in Computer Science specializing in Data Analytics at APU, where I have been constantly honing my technical skill set in a fast-paced environment. I am familiar with programming languages such as Python, C, and Java, and currently venturing into front-end development using Next.js and React. 
